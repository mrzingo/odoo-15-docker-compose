...
``` bash
curl -s https://raw.githubusercontent.com/mrzingo/odoo-15-docker-compose/master/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://raw.githubusercontent.com/mrzingo/odoo-15-docker-compose/master/run.sh | sudo bash -s odoo-two 11015 21015
```
